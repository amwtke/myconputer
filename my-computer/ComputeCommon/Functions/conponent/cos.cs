...
{
    public class cos : FuncationAbstract, IFunctionConponent
    {
        ...
        public double Compute(string expression)
        {
            ...
            {
                int stackdeep = 0;
                return Math.Cos(ComputerCore<GeneralNode>.Compute(ComputerCore<GeneralNode>.Scan(ComputerCore<GeneralNode>.LoadExpression(args[0]), ref stackdeep)));
            }
